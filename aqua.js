       ...
       console.log("ipad:" + ipad);
        var key = data["key"];
         if (ipad === 'Yes'){
           ...
           //Please Scan Below QR Code via the iPad stand in our lobby
         document.getElementById('note').innerHTML= "Thank you, " + data["fname"] + " " + data["lname"] + "<br><br><b>Mobile Phone Users:</b><br>To Check-In, Please Scan Below QR Code<br>via the iPad stand in our lobby";
